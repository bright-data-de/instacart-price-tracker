# Instacart Price Tracker

[![Bright Data](https://img.shields.io/badge/Powered%20by-Bright%20Data-blue?style=flat-square)](https://brightdata.de)
[![Instacart Price Tracker](https://img.shields.io/badge/Instacart%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/instacart)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/instacart)

Instacart-Preisverfolgung in Echtzeit – eine nordamerikanische Plattform für Lebensmittellieferungen am selben Tag. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder eine **Self-Service-API**, um Ihre eigene Pipeline zu erstellen.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/instacart)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper, die erstellt werden müssen, keine Infrastruktur, die gewartet werden muss – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Verfolgen Sie die Lebensmittelpreisinflation** über Kategorien hinweg auf Instacart
...
- ✅ Verfolgen Sie Wettbewerberaktionen und Werbedynamiken
- ✅ Speisen Sie saubere, harmonisierte Daten direkt in dynamische Preisalgorithmen oder KI-Modelle ein

> **Ab $250/Monat – [Erhalten Sie ein individuelles Angebot →](https://brightdata.de/products/insights/price-tracker/instacart)**

---

## Option 2: Self-Service über Web Scraper API

Möchten Sie lieber Ihre eigene Pipeline erstellen? Die **Web Scraper API** von Bright Data bietet Ihnen programmatischen Zugriff auf Instacart-Produktdaten – Preise, Verfügbarkeit, Bewertungen und mehr – ohne dass Sie Proxys oder Scraping-Infrastruktur verwalten müssen.
...
- Eine Bright Data **Web Scraper ID** für Instacart-Produkte ([finden Sie Ihre im Web Scrapers Control Panel](https://brightdata.de/cp/scrapers))
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/instacart-price-tracker.git
   cd instacart-price-tracker
   ```
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > suchen Sie nach "Instacart" und kopieren Sie die Web Scraper ID (Format: `gd_xxxxxxxxxxxx`).
...
Übergeben Sie eine Liste von Instacart-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.instacart.com/products/sample-product",
...
Sammeln Sie alle Produkte von einer Instacart-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://instacart.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.instacart.com/products/sample-product",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://instacart.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.instacart.com/products/sample-product"}]
...
- 🌟 [Instacart Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/instacart)
- 🔧 [Instacart Scraper API](https://brightdata.de/products/web-scraper/instacart)
